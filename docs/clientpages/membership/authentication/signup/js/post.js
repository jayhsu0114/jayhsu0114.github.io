document.getElementById('registration-form').addEventListener('submit', function(event) {
    ...
    const formData = {
        ...
        birthday_information_year: document.getElementById('birthday-information-year').value,
        birthday_information_month: document.getElementById('birthday-information-month').value,
        birthday_information_date: document.getElementById('birthday-information-date').value,
